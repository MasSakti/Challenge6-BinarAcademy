...
import com.mutawalli.challenge6.databinding.FragmentUpdateProfileBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (userData != null) {
            binding.apply {
                ...
                binding.ivProfile.setImageURI(saveImageToInternalStorage)
        ...
        binding.btnSaveUpdate.setOnClickListener {
            ...
            val address = binding.etBirthUpdate.text.toString()
